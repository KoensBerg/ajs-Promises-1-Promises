# Задача #1 («Promises») к лекции «Promises, async/await»

[![Build status](https://ci.appveyor.com/api/projects/status/8lwd2ljapvy3u7df?svg=true)](https://ci.appveyor.com/project/KoensBerg/ajs-promises-1-promises)
